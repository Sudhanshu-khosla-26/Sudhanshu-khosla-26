...
const sudhanshu = {
    ...
    workingOn: "Cybersecurity tool for detecting vulnerabilities in codebases",
    interests: ["DevOps", "Real-time Applications", "Security Engineering"],
...
- ☁️ Deepening expertise in **Cloud-Native Development**
